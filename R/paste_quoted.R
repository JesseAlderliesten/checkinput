...
#' (2) [base::chkDots()] with argument `allowed` implemented from \R 4.6.0;
#' (3) [methods::dotsMethods]; (4) functions `check_dots_empty()`,
#' `check_dots_unnamed()`, and `check_dots_used()` in package `ellipsis`;
#' (5) [this StackOverflow post](https://stackoverflow.com/questions/64001629);
...
#'
#' @seealso [base::paste0()] [base::toString()] which can be used instead of
#' `paste(x, collapse = ", ")`
