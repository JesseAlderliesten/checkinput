...
other functions. Errors *are* thrown about invalid input to arguments other than
`x`, e.g., when values other than `TRUE` or `FALSE` are used for `allow_zero`.
...
arguments, e.g., `allow_underscores = FALSE`.
