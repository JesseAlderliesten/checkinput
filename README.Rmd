...
either `TRUE` or `FALSE` and do not throw errors caused by input to `x`. Errors
*are* thrown about invalid input to arguments other than `x`, e.g., providing
values other than `TRUE` or `FALSE` to `allow_zero`. See the vignette about
...
For information about installing and configuring R and RStudio, or about setting
up and using Git and GitHub, see my
[repository 'InstallPkgs'](https://github.com/JesseAlderliesten/InstallPkgs).
