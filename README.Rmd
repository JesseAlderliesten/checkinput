...
need of the specific function for which the input is checked. In addition, it
contains a few functions to make it easier to construct messages about numeric
input.
