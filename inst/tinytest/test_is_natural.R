...
expect_false(is_natural(x = Inf, strict = FALSE))
expect_false(is_natural(x = integer(0), allow_zero_length = FALSE, strict = FALSE))
expect_true(is_natural(x = integer(0), allow_zero_length = TRUE, strict = FALSE))
expect_false(is_natural(x = numeric(0), allow_zero_length = FALSE, strict = FALSE))
expect_true(is_natural(x = numeric(0), allow_zero_length = TRUE, strict = FALSE))
expect_false(is_natural(x = NULL, allow_zero_length = TRUE, strict = FALSE))
...
expect_false(all_natural(x = integer(0), allow_zero_length = FALSE, strict = FALSE))
expect_true(all_natural(x = integer(0), allow_zero_length = TRUE, strict = FALSE))
expect_false(all_natural(x = numeric(0), allow_zero_length = FALSE, strict = FALSE))
expect_true(all_natural(x = numeric(0), allow_zero_length = TRUE, strict = FALSE))
expect_false(all_natural(x = NULL, allow_zero_length = TRUE, strict = FALSE))
